...
export default defineCaseStudy({
  es: [
    ...
    },
    {
      ...
      body: "Los hallazgos permitieron definir un MVP enfocado en reducir la fragmentación del proceso. La aplicación debía permitir \n**explorar → filtrar → encontrar → gestionar**\n sin tener que repetir información constantemente.",
      items: [
  ...
  en: [
    ...
    },
    {
      ...
      body: "The findings let us define an MVP focused on reducing fragmentation. The app had to allow \n**browse → filter → find → manage**\n without constantly repeating information.",
      items: [
