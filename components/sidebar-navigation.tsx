...
export function SidebarNavigation({
  ...
  return (
    <>
      ...
      {/* Mobile Navigation - under 1165px - Split into two containers */}
      <div className="mobile-nav">
        {/* Main Navigation Container - Top but below safe area */}
        <nav className="fixed top-0 left-0 right-0 z-50 pt-safe">
          <div className="glass-effect mx-1 sm:mx-4 mt-4 sm:mt-6 rounded-2xl p-1.5 sm:p-3">
            <div className="flex items-center justify-center gap-1 sm:gap-3">
              ...
              {/* Separator */}
              <div className="w-px h-6 sm:h-8 bg-muted-foreground/30 mx-1 sm:mx-2"></div>
              ...
              <Button
                ...
                variant="ghost"
                size="sm"
                className="w-8 h-8 sm:w-10 sm:h-10 p-0 rounded-lg hover:bg-secondary/20 hover:scale-105 transition-all duration-300"
                title={theme === "light" ? 
        ...
        {/* Download CV Button - Bottom Right (Larger) */}
        <div className="fixed bottom-0 right-0 z-50 pb-safe pr-safe">
          <div className="mr-3 sm:mr-6 mb-3 sm:mb-6">
            <Button
              onClick={downloadCV}
              variant="secondary"
              size="lg"
              className="px-4 sm:px-6 py-2.5 sm:py-3 h-auto rounded-xl hover:bg-secondary/90 hover:scale-105 transition-all duration-300 text-sm sm:text-base font-medium shadow-xl"
            >
